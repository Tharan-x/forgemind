  ...
  return (
    <ProtectedLayout>
      <div className="space-y-8">
        ...
        {/* WORKSPACE TAB VIEW WRAPPED IN ERROR BOUNDARY */}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-zinc-400 leading-snug">
                        Deep structural insights, grounded code explanations, dependency
                        intelligence, and blast radius analysis.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  {archLoading ? (
                    <div className="bg-zinc-900/60 border border-zinc-800 rounded-2xl p-8 text-center">
                      <LoadingSpinner
                        size="md"
                        label="Loading repository architecture metrics..."
                      />
                    </div>
                  ) : archError ? (
                        ...
                        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-4">
                          ...
                          <div className="space-y-2.5">
                            {Object.entries(archOverview.languageDistribution)
                              ...
                              .map(([lang, count]) => {
                                const pct = (
                                  (count / (archOverview.totalFiles || 1)) *
                                  100
                                ).toFixed(1);
                                return (
                                  ...
                                  (pair.assistant.metadata['sources'] as RAGSourceCitation[])
                                    ...
                                    <div className="space-y-2 pt-1">
                                      <span className="text-[10px] font-bold text-zinc-500 uppercase tracking-wider block">
                                        ...
                                        {
                                          (
                                            pair.assistant.metadata[
                                              'sources'
                                            ] as RAGSourceCitation[]
                                          ).length
                                        }{' '}
                                        snippet
                                        {(pair.assistant.metadata['sources'] as RAGSourceCitation[])
